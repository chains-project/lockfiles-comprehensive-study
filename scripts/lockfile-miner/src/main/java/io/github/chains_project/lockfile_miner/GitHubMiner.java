 ...
 * This class is based on the GitHubMiner from the Bump project.
 */
public class GitHubMiner {
     ...
     */
    static final String FOUND_REPOS_FILE = "";
    static final String NOT_FOUND_REPOS_FILE = "";
    /**
    ...
    /**
     * Query GitHub for repositories that are Maven projects. The found repositories
     ...
     */
    public void findRepositories(RepositoryList repoList, RepositorySearchConfig searchConfig, Date lastDate, String projectType) throws IOException, InterruptedException {
                            ...
                            try {
                                CompletableFuture<ProjectInfo> projectCheck = CompletableFuture.supplyAsync(() -> {
                                    if (RepositoryFilters.hasSufficientNumberOfCommits(repository, searchConfig.minNumberOfCommits) &&
                                        ...
                                        return RepositoryFilters.identifyProjectTypeAndLockfile(repository, projectType);
                                    }
                                    return null;
                                });
     ...
     * To minimize the chance of hitting the GitHub API rate limit, the language filter can be specified.
     */
