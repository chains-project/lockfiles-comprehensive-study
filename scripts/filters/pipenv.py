    ...
    for project_name, project_data in projects.items():
        if 'PIP' in project_data.get('projectType', []):
            ...
            try:
                ...
                # Here as well, we do not need to go through all sections, if we just want to see if there is at least one dependency.
...
if __name__ == "__main__":
    count_pipenv_dependencies("path_to_the_pipenv_projects_json_file.json")